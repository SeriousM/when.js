(function (window, $) {
  ...
  var getAsync = function(test, name, interval){
    return function(){
      var self = this;
  ...
  describe("when.js tests", function(){
    ...
    it("#02", function(){
      console.log("#02");
      var func1 = getAsync(this, 1, 150);
      var func2 = getAsync(this, 2, 100);
    ...
    it("#07", function(){
      ...
      var func3 = getAsync(this, 3, 75);
      var func4 = getAsync(this, 4, 50);
      var func5 = getAsync(this, 5, 350);
      var func6 = getAsync(this, 6, 410);
      var func7 = getAsync(this, 7, 333);
      var func8 = getAsync(this, 8, 123);
    ...
    it("#24", function(){
      console.log("#24");
      var func1 = getAsync(this, 1, 150);
      var func2 = getAsync(this, 2, 57);
      var func3 = getAsync(this, 3, 96);
      var func4 = getAsync(this, 4, 85);
      var func5 = getAsync(this, 5, 57);
    ...
    it("#26", function(){
      ...
      var func4 = getAsync(this, 4, 85);
      var func5 = getAsync(this, 5, 57);
      var func6 = getAsync(this, 6, 73);
      var func7 = getAsync(this, 7, 88);
      var func8 = getAsync(this, 8, 24);
      var func9 = getAsync(this, 9, 15);
